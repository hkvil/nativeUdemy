...
public class DessertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView dessertsDish = findViewById(R.id.list_View_desserts);
        ...
        ArrayAdapter<Dish> dessertsArrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, dishes);
        dessertsDish.setAdapter(dessertsArrayAdapter);
