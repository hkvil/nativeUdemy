...
import static com.example.restoblox.R.*;
...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_main_courses);

        ListView mainsDish = findViewById(id.list_view_main_courses);

        Dish[] dishes = {new Dish("Thai basil and mulberry salad", "A crisp salad featuring fresh thai basil and mulberry", 1499),
        ...
        mainsDish.setAdapter(dishesArrayAdapter);
